...
public class RelativeLocatorsConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.get("https://www.aqi.in/dashboard/australia");
		driver.get("https://www.espncricinfo.com/series/indian-premier-league-2022-1298423/points-table-standings");
		driver.manage().window().maximize();
		Thread.sleep(2000);
		// findFamilyElements("Jaipur, India", "p", "p", "p", "p");
		//findFamilyElements("Scottsdale, Australia", "p", "p", "p", "p");
		//findFamilyElements("Wagga-Wagga, Australia", "p", "p", "p", "p");
	...
	public static void findFamilyElements(String base, String e1, String e2, String e3, String e4) {
		...
		WebElement baseEle = driver.findElement(By.linkText(base));
